...
public class LocalWakeupCustom extends Activity implements View.OnClickListener {

    private static final String TAG = "LocalWakeupCustom";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!AIWakeupEngine.checkLibValid()) {
            ...
            mEngine.setUseRecord(false);//不使用SDK内部录音机收音，用户自定义feed音频数据
