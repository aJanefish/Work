...
public class AppUtils {
	...
	private static AppUtils infoUtil;
	...
	public static AppUtils getInstance(Context context) {
		if (infoUtil == null) {
			infoUtil = new AppUtils(context);
		}
		return infoUtil;
	}
	
	/** 获取已安装的APP **/
	public HashMap<String,AppInfo> getInstalledApps(int type) {
	...
	private HashMap<String,AppInfo> getAppInfoByPackageInfo(List<PackageInfo> list) {
